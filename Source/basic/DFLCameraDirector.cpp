...
ADFLCameraDirector::ADFLCameraDirector()
{
...
void ADFLCameraDirector::create_cameras(ADFLCharacter *character)
{
...
USceneCaptureComponent2D *ADFLCameraDirector::get_last_camera_available()
{
    /*
